...
- [ ] Accessibility pass for the explorers & remaining pages (Scales, Chord Explorer, Circle of Fifths, Diatonic Chords, Metronome, Play-Along, Dexterity, Practice Dashboard, Settings): focus, ARIA, contrast — plus ARIA on the shared Fretboard/Keyboard/Staff SVG components (focusable hit targets, roles/labels)
